...
<p className="mt-5 text-sm leading-relaxed max-w-sm" style={{ color: "rgba(255,255,255,0.65)" }}>
...
<span key={txt} className="flex items-center gap-1.5 text-xs" style={{ color: "rgba(255,255,255,0.5)" }}>
